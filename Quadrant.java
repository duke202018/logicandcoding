...
public class Quadrant
{
    public static void main( String[] args) {
        ...
        System.out.println("Please insert x coordinate");  //prompt the user for an x-coordinate
        x = keys.nextDouble();
        System.out.println("Please insert y coordinate");  //prompt the user for a y-coordinate
        y = keys.nextDouble();
        keys.close();
